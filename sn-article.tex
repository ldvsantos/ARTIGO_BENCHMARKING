...
\title[Paradigma estatístico e qualidade do solo]{Escolha do paradigma estatístico como condicionante da avaliação integrada de qualidade do solo em Argissolo sob manejo conservacionista de longa duração}
...
Os cinco paradigmas exibiram concordância significativa no ranqueamento de combinações manejo--cobertura por qualidade do solo, embora essa concordância tenha se distribuído em três camadas de intensidade. Os paradigmas baseados em aprendizado de máquina e lógica fuzzy produziram ranqueamentos praticamente intercambiáveis, o PLS-SEM ocupou posição intermediária e a ANOVA divergiu dos demais, indicando que a escolha da família analítica pode alterar conclusões de manejo. A concordância tendeu a estabilizar acima de um limiar mínimo de observações, sugerindo que o tamanho amostral condiciona a confiabilidade de exercícios comparativos inter-paradigma. Pesquisadores com bases suficientemente amplas podem selecionar qualquer paradigma não linear sem perda prática de informação, ao passo que comparações envolvendo o paradigma linear requerem verificação de sensibilidade.
